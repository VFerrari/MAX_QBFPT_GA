...
public abstract class AbstractGA<G extends Number, F> {
	 ...
	 */
	protected final populationReplacement popMethod;
	 ...
	 * @return The updated population for the next generation.
	 */
	protected Population elitism(Population offsprings) {
	 ...
	 * @return The updated population for the next generation.
	 */
	protected Population steadyState(Population original, Population offsprings) {
